...
const RECIPES = [
  ...
  { name: 'Sunday Morning Breakfast', emoji: '🥞', description: 'The sizzle from the kitchen would wake us up better than any alarm clock.', memory: 'Sundays were sacred. The whole family at the table. The best mornings of my life.', ingredients: ['Pancakes', 'Butter', 'Syrup', 'Chai', '... and your laughter'], color: '#A8D4F5' },
